...
#define FLAG_TERA_ORB_CR       0x23 // used Flag
#define FLAG_RECEIVED_TERA_ORB 0x24 // used Flag
...
#define FLAG_HIDE_LALUS_STEVEN_OUTSIDE       0x68 // used Flag
...
#define FLAG_VISITED_LALUS                          (SYSTEM_FLAGS + 0x21) // used Flag
