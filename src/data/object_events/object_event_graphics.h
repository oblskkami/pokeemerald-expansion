...
const u16 gObjectEventPal_Wingull[] = INCGFX_U16("graphics/object_events/palettes/wingull.pal", ".gbapal");
...
const u32 gObjectEventPic_WingullOld[] = INCGFX_U32("graphics/object_events/pics/pokemon_old/wingull.png", ".4bpp", "-mwidth 2 -mheight 4");
