...
const u8 gText_Follower[] = _("跟随");
const u8 gText_FollowerSet[] = _("放出");
const u8 gText_FollowerReturn[] = _("收回");
const u8 gText_FollowerUnset[] = _("重置");
const u8 gText_FollowerPreferred[] = _("{STR_VAR_1}现在开始跟随你了。{PAUSE_UNTIL_PRESS}");
const u8 gText_FollowerDefaulted[] = _("重置了跟随。{PAUSE_UNTIL_PRESS}");
const u8 gText_FollowerFainted[] = _("不能把昏厥的宝可梦派出来跟随！{PAUSE_UNTIL_PRESS}");
const u8 gText_FollowerReturnedToBall[] = _("{STR_VAR_1}回到了球里。{PAUSE_UNTIL_PRESS}");
const u8 gText_DoWhatWithFollower[] = _("要{STR_VAR_1}怎么做?");
