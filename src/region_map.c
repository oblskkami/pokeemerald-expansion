...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_1] = {MAP_GROUP(MAP_LALUS), MAP_NUM(MAP_LALUS), HEAL_LOCATION_LALUS},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_ROUTE_1:
        return FlagGet(FLAG_VISITED_LALUS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;    
